school_classes = [
    ...
    {'school_class': '2c', 'scores': [4, 4, 4, 4, 2]},
    {'school_class': '2d', 'scores': [2, 2, 1, 2, 3]},
    {'school_class': '3a', 'scores': [3, 4, 4, 5, 2]},
    {'school_class': '4b', 'scores': [3, 3, 5, 5, 5]},
    {'school_class': '5c', 'scores': [4, 4, 4, 4, 2]},
    {'school_class': '6d', 'scores': [2, 2, 1, 2, 3]},
]
